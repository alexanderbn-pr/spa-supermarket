...
export const recipeSchema = z.object({
  ...
  type_id: z.string().min(1, 'Selecciona un tipo'),
  difficulty_id: z.string().min(1, 'Selecciona una dificultad'),
  meal_type_id: z.string().min(1, 'Selecciona un tipo de comida'),
  healthy_level_id: z.string().min(1, 'Selecciona un nivel saludable'),
